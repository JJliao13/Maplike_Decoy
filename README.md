This repository contains the data and script which used in analyzing the data of Spatial Decoy Effect Task. The data and script are placed in the Data folder.  
